...
<head>
  ...
  <title>Membership Renewal Management</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Membership Renewals</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
...
<div class="card-header">
        <h3 class="card-title">Membership Renewal DataTable</h3>
    </div>
              <div class="card-body">
...
<tr role="row" class="odd">
    ...
    <td><%= member.getExpiryDate() != null ? member.getExpiryDate().toString() : "N/A" %></td>
    <td>
        <a class="btn btn-success" href="RenewServlet?action=renew&id=<%= member.getId() %>">Renew</a>
    </td>
</tr>
<%
        }
