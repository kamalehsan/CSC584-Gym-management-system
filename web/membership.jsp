...
<div class="wrapper">
  ...
  <div class="content-wrapper">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="number" class="form-control" id="membershipAmount" name="membershipAmount" placeholder="Enter membership amount" required>
                                        </div>
                                    </div>
                                </div>
    ...
    <footer class="main-footer">
        <strong>&copy; <%= new java.util.Date().getYear() + 1900 %> GSMbro</strong> 
